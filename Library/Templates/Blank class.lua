...
function GUI.Template:on_mouse_down()
...
function GUI.Template:on_double_click()

	self:redraw()
end


function GUI.Template:on_drag()
...
function GUI.Template:on_wheel(inc)
