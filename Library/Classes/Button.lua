...
-- Button - Mouse down.
function GUI.Button:on_mouse_down()
...
-- Button - Mouse up.
function GUI.Button:on_mouse_up() 
...
function GUI.Button:on_double_click()
...
function GUI.Button:on_r_mouse_up()

	if GUI.is_inside(self, GUI.mouse.x, GUI.mouse.y) and self.r_func then
