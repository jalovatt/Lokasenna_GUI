...
GUI.wnd.name = "Example - Main, Z, and Methods"
GUI.wnd.x, GUI.wnd.y, GUI.wnd.w, GUI.wnd.h = 0, 0, 300, 128
...
function GUI.elms.sldr_pan:on_mouse_down()
	
	-- Run the slider's normal method
	GUI.Slider.on_mouse_down(self)
...
function GUI.elms.sldr_pan:on_drag()
	GUI.Slider.on_drag(self)
	update_pan()
end
function GUI.elms.sldr_pan:on_wheel()
	GUI.Slider.on_wheel(self)
	update_pan()
end
function GUI.elms.sldr_pan:on_double_click()
	GUI.Slider.on_double_click(self)
	update_pan()
end
