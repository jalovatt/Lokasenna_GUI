...
GUI.req("Classes/Menubar.lua")()
GUI.req("Classes/Button.lua")()
GUI.req("Classes/Listbox.lua")()
GUI.req("Classes/TextEditor.lua")()
...
GUI.wnd.name = "Example - Menubar, Listbox, and TextEditor"
GUI.wnd.x, GUI.wnd.y, GUI.wnd.w, GUI.wnd.h = 0, 0, 800, 272
...
GUI.new("mnu_menu", "Menubar",      1,  0,   0,   menus, GUI.wnd.w)
...
function GUI.elms.lst_titles:on_double_click()
